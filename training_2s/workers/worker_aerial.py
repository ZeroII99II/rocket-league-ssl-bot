...
# JSTN 2S Training Configuration
# Optimized for 2s gameplay with jstn's 2s playstyle
# Team size: 2 | Episodes per switch: 1500

# JSTN (Justin) Training Configuration
# Optimized for aerial mechanics with jstn's playstyle
...
if __name__ == "__main__":
    ...
    match = Match(
        ...
        obs_builder=ModernObsBuilder_Legacy(expanding=True, tick_skip=Constants_aerial.FRAME_SKIP, team_size=team_size,
                                            extra_boost_info=False),
        obs_builder=ModernObsBuilder(expanding=True, tick_skip=FRAME_SKIP, team_size=2, stack_size=5, extra_boost_info=True, embed_players=True, selector=True, doubletap_indicator=True, flip_reset_counter=True, aerial_mechanics=True, wall_play_detection=True, recovery_tracking=True, opponent_modeling=True),
