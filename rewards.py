...
# Try to import from rlgym.utils, fallback to constants if not available
try:
    ...
    BLUE_TEAM = 0
    BLUE_GOAL_BACK = np.array([0, -5120, 0])
    ORANGE_GOAL_BACK = np.array([0, 5120, 0])
    ORANGE_TEAM = 1
    BALL_MAX_SPEED = 6000
    CAR_MAX_SPEED = 2300
    BALL_RADIUS = 92.75
...
# TODO remove this
# from CoyoteObs import print_state  # Removed - file deleted
