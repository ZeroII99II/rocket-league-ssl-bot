...
# Try to import RLGym components
try:
    ...
    BOOST_LOCATIONS = np.array([
        ...
        [-1024, -4096, 70], [1024, -4096, 70], [-2048, -3072, 70],
        [2048, -3072, 70], [-1024, -3072, 70], [1024, -3072, 70],
        [-1024, -1024, 70], [1024, -1024, 70], [-1024, 1024, 70],
        [1024, 1024, 70], [-1024, 3072, 70], [1024, 3072, 70],
        [-2048, 3072, 70], [2048, 3072, 70], [-1024, 4096, 70],
        [1024, 4096, 70], [-1792, 4184, 70], [1792, 4184, 70], [0, 4240, 70]
    ])
