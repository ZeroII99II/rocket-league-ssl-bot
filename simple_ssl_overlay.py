...
"""
Simple SSL Overlay
Simple visual overlay that displays on top of Rocket League game window
"""
...
class SimpleSSLOverlay:
    """Simple visual overlay for Rocket League"""
    ...
    def overlay_update_loop(self):
        ...
        try:
            while self.is_running and self.overlay_window:
                ...
                sleep_time = max(0, 0.016 - elapsed)  # 60 FPS
    ...
    def start_overlay(self):
        ...
        try:
            print("🚀 Starting Simple SSL Overlay...")
